...
buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/SanzuSex"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/SanzuSex"),
            ],
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://github.com/AnonDevils/VideoPlayerBot"),
            ]
         ]
